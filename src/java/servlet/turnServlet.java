 ...
 * @author ANDRES
 */
@WebServlet(name = "turnServlet", urlPatterns = {"/playAgain"})
public class turnServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        //conseguimos el parametro de usuario, nos dira quien gano
        String whoBegins = request.getParameter("player");
        System.out.println(whoBegins);
        //este metodo conseguira la ficha del usuario, 
        boolean token=gc.Token();
        
        gc.beginWithUser(whoBegins);
        // initialize game
        gc.startGame();
